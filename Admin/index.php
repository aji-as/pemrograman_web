...
<?php 
    error_reporting(0);
    session_start();
    if (!isset($_SESSION['username']) or $_SESSION['level'] != "admin"){
...
<html lang="en">
  ...
  <head>
    ...
    <!--begin::Required Plugin(AdmiHHnLTE)-->
    ...
    <div class="app-wrapper">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="./../src/assets/img/avatar2.png"
      ...
      <aside class="app-sidebar bg-primary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          <!--begin::Brand Link-->
          <a href="./?p=admin" class="brand-link">
            <!--begin::Brand Image-->
            <img
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Giestar</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./?p=ganti_pass" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Ganti password</p>
                </a>
              </li>

...
<main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <!--begin::Col-->
              <div class="col-sm-6"><h3 class="mb-0">Edit data pegawai</h3></div>
              <!--end::Col-->
              <!--begin::Col-->
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <form action="#" method="post">
                <?php
                    ...
                    $sql = "SELECT * FROM pegawai  WHERE id='$xid'";
                    ...
                    if(isset($_POST['simpan'])){
                            ...
                            $sql = "UPDATE pegawai SET nik='$nik', nama='$nama', gender='$jk',  alamat='$alamat', hp='$hp' WHERE id='$xid'";
                            $a = $koneksi->query($sql);

                            if($a){
                                echo "
                                <div class='alert alert-success'>
                                    Berhasil diedit! <a href='./?p=pegawai'>Lihat Data!</a>
                                </div>
                                ";
                            }
                        }
                        echo "
                            <table class='table table-bordered table-hover table-striped'>
                                    <tr>
                                        <td>nik</td>
                                        <td><input type='number' name='nik' class='form-control' value='$d[nik]'></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Lengkap</td>
              ...
              <!--end::Col-->
               <div class="col">
                    <a href="./?p=pegawai" class="btn btn-info m-10"><< Kembali</a>
                </div>
            </div>
            <!--end::Row-->
          </div>
